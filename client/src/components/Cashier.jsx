        ...
        const data = [{
            ...
            <div style="font-family: Arial, sans-serif; font-size: 10px; width: 100%; display: flex; justify-content: center; flex-direction: column;">
                ...
                <div style="width: 100%; border-top: 2px dotted black; border-bottom: 2px dotted black">
                    <p style="text-align: center; font-size: 10px;">Total Keseluruhan: <span style="font-weight: bold">${rupiah(totalKeseluruhan)}<span/> <span style="font-weight: normal">| Keterangan: <span/><span style="font-weight: bold">${hutang}<span/></p>
                </div>
                <div style="width: 100%">
